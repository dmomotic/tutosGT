...
<div class="main main-raised">
    <div class="container">
        ...
        <div class="section ">
            <h2 class="title text-center">Agregar nuevo documento</h2>
            ...
            <form method="post" action="{{ url('/admin/documents') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <button type="submit" class="btn btn-primary btn-round">Agregar Documento</button> 
